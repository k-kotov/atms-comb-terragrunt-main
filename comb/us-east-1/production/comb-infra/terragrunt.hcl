...
inputs = {
  ...
  route53_zone_id         = "Z068007938E3DIV0AKGFY"
  alb_route53_record_name = "app.comb.insight-atms.com"
  ...
  app_twingate_group_ids      = ["R3JvdXA6MjA4Mjk5", "R3JvdXA6MjA4NjE1"]
  database_twingate_group_ids = ["R3JvdXA6MjA4Mjk5", "R3JvdXA6MjA4NjE1"]
}